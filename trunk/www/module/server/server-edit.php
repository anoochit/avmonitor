...
<tr class="table-row">
	<td>Server Name </td>
	<td width="300px"><input type="text" name="servername" value="<?=$observer->servername; ?>"></td>
</tr> 
<tr class="table-row">
	<td>Hostname </td>
	<td width="600px"><input type="text" name="hostname" value="<?=$observer->hostname; ?>"> (FQDN or IP Address)</td>
</tr> 
<tr class="table-row">
	<td>Owner </td>
